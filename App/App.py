...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Pratik@2610',db='cv')
...
st.markdown(
    ...
    /* Counter styling */
    [data-testid="stSidebar"] p {
        font-size: 14px; /* Smaller text for counter */
        text-align: center; /* Center the text */
        margin-top: 20px; /* Space above the counter */
        color: #7f8c8d; /* Gray color for less emphasis on the counter */
    }

    .stSelectbox > div {
    border: 2px solid #3498db; /* Blue border only for the dropdown */
    border-radius: 5px; /* Rounded corners */
    padding: 5px; /* Padding for better spacing */
    }

    /* Custom cursor for dropdown */
    .stSelectbox select {
        cursor: url('https://www.example.com/custom-cursor.png'), auto; /* URL to your custom cursor */
    }
...
def run():
    ...
    st.sidebar.markdown('''<h1 style='text-align: center; color: #4CAF50;'>🌟Pick Your Option🌟</h1>''',unsafe_allow_html=True)
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox(" Please Make Your Selection Below ", activities)
    link = '''
    <b style="font-size: 18px; font-family: Arial, sans-serif;">
    Crafted with care by 
    <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #4CAF50; font-weight: bold;">
        Pratik
    </a>
    </b>
    ''' 
    ...
    if choice == 'User':
        ...
        act_mail = st.text_input('Email', placeholder="Enter your email")
        ...
        # Upload Resume
        st.markdown('''
        <div style="text-align: center; color: #4A90E2; font-family: 'Helvetica', sans-serif; 
        font-weight: 600; letter-spacing: 1px; text-transform: uppercase; 
        background-color: #f0f4f7; padding: 10px; ">
        Submit Your CV Now
        </div>
        ''', unsafe_allow_html=True)
    ...
    font-weight: bold; font-size: 18px; background-color: #ECF0F1; 
...
''', unsafe_allow_html=True)
        ...
        if pdf_file is not None:
            with st.spinner('Hang on while we process your resume...'):
                time.sleep(4)
            ...
            if resume_data:
                ...
                st.success("Welcome back "+ resume_data['name'])
                st.subheader("**Your Key Information 🔑**")
                try:
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        About The Tool - **AI Resume Analyzer**
        </div>
        <div style="text-align: left; color: #34495e; font-family: 'Arial', sans-serif; 
        font-size: 18px; line-height: 1.6; padding: 15px;">
        Welcome to the AI Resume Analyzer, crafted with care by **Pratik Raut**. This innovative tool uses natural language processing to parse and analyze information from your resume. It identifies keywords and categorizes them into sectors based on their relevance. Additionally, it provides personalized recommendations, predictions, and analytics based on keyword matching to enhance your job application prospects.

        <strong>How to Use It:</strong>
        <ul style="line-height: 1.8;">
            <li><strong>User</strong>: Choose yourself as a user in the sidebar. Fill in the required fields and upload your resume in PDF format. Then, sit back and relax while our tool works its magic.</li>
            <li><strong>Feedback</strong>: We value your input! Please suggest any feedback you may have about the tool to help us improve.</li>
            <li><strong>Admin</strong>: For admin access, use the username <strong>admin</strong> and the password <strong>admin@resume-analyzer</strong>. This will allow you to manage the tool and perform in-depth analysis.</li>
        </ul>
       </div>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'pratik' and ad_password == '1':
                ...
                st.success("Hello Pratik! 🎉 A total of %d users have utilized our tool! 😊" % values )                
